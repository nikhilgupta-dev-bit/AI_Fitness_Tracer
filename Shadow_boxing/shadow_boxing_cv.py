...
def draw_ui(frame, stats: SessionStats, fps: float, event_text: str) -> None:
    cv2.rectangle(frame, (0, 0), (530, 155), (25, 25, 25), -1)
    ...
    with mp_pose.Pose(
        ...
        while True:
            ...
            if result.pose_landmarks:
                ...
                if out["left_punch"] and out["right_punch"]:
                    event_text = "DOUBLE"
                elif out["left_punch"]:
                    event_text = "LEFT STRAIGHT"
                elif out["right_punch"]:
            ...
            draw_ui(frame, analyzer.stats, fps, event_text)
